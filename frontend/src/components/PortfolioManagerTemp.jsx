    ...
    <div className="p-8 text-center">
      <div className="max-w-md mx-auto bg-yellow-50 border border-yellow-200 rounded-lg p-6">
        ...
        <p className="text-yellow-700 mb-4">
          Portfolio management features require backend connectivity. Currently using static frontend data.
        </p>
...
export default PortfolioManagerTemp